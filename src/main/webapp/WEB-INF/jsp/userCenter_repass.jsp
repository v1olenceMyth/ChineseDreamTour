						...
						<div class="fcard">
							<table border="0" cellpadding="0" cellspacing="0" width="636">
								<tr>
									...
									<td align="left" height="30"><input type="text"
										class="finput3"></td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2" align="center" valign="middle" height="50"><input
										type="image" src="images/fbtn8.png"></td>
								</tr>
							</table>
						</div>
						<div class="fpw">安全问题</div>
						<div class="fcard">
							<table border="0" cellpadding="0" cellspacing="0" width="636">
								<tr>
									<td align="right" height="30">问题一：</td>
									<td align="left" height="30"><select><option>-------选择问题-------</option></select></td>
								</tr>
								<tr>
									<td align="right" height="30">答案：</td>
									<td align="left" height="30"><input type="text"
										class="finput3"></td>
								</tr>
								<tr>
									<td align="right" height="30">问题二：</td>
									<td align="left" height="30"><select><option>-------选择问题-------</option></select></td>
								</tr>
								<tr>
									<td align="right" height="30">答案：</td>
								...
								<tr>
									<td align="right" height="30">问题三：</td>
									<td align="left" height="30"><select><option>-------选择问题-------</option></select></td>
								</tr>
								<tr>
									<td align="right" height="30">答案：</td>
