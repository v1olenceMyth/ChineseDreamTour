	...
	<div class="b_wrap">
		...
		<div class="fmember">
			...
			<div class="fmright">
				<div class="fmr1">
					...
					<div class="fmr1_m">
						<div class="fgr">
							...
							<div class="fgr_zl">
								<p class="fp2">
									小蜂蜜，<span class="fspan1">您好！</span>
								</p>
								<p class="fp1">
									安全级别：<img src="images/fgrpic1.png" align="absmiddle">
									&nbsp;&nbsp;<img src="images/ficon1.png">&nbsp;&nbsp;<img
										src="images/ficon2.png">&nbsp;&nbsp;
									验证手机和邮箱可分别获得&nbsp;&nbsp;<a href="#">安全设置</a>
								</p>
								<p class="fp2">
									现金账户：<span class="fspan2">￥200</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;抵用劵：<span
										class="fspan2">￥0</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;旅游劵：<span
										class="fspan2">￥0</span>
								</p>
							</div>
							<br style="clear: both">
						...
						<div class="forder">
							...
							<div class="for_m">
								<div class="for_t4">
									订 单 号：183982xx <br> 预定时间：2013-09-09<br>
									出游时间：2013-09-15
								</div>
								<div class="for_t2">
									<img src="images/forpic1.png" align="absmiddle">&nbsp;<span
										class="fspan3">某某产品周边游</span>
								</div>
								<div class="for_t3">等待确认</div>
								<div class="for_t3">代付款</div>
								<div class="for_t3">
									<a href="#">去付款</a><a href="#" class="a1">查看</a>
								</div>
								<br style="clear: both">
							</div>
						</div>
				...
				<div class="fmr2">
					<div class="fmr2_top">
						<span class="fspan4"><a href="#">更多>></a></span>杭州周边热门景点
					</div>
					<div class="fmr2_m">
						<div class="fmr2_m1">
							<div class="fmr2_m1pic">
								<img src="images/fzbpic1.png">
							</div>
							<div class="fmr2_m1text">
								<a href="#">西湖</a>
							</div>
						</div>
						<div class="fmr2_m1">
